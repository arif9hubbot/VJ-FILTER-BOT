...
auth_channel = environ.get('AUTH_CHANNEL', '1002320755700') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mdarif7811919523:MtPbFD5j7zuYNslT@cluster0.m1nle.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+2mm2SWvTCPJlNDZl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/arif9hubbot')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mdarifbot1') # Support Chat Link Without https:// or @
